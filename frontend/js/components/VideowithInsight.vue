...
<template>
  <div class="flex gap-4 w-full">
    <video
      ...
      height="250" 
      :src="props.video_url"
      class="object-contain rounded-lg bg-black"
      controls>
    </video>
    ...
    <UCard class="w-[60%]">
      ...
      <div v-if="!is_processing && props.data" class="flex shrink-0">
      ...
      <div v-else-if="!is_processing && !props.data" class="text-gray-500 italic py-4">
