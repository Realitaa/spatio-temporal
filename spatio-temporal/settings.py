"""
Django settings for spatio-temporal project.
...
MIDDLEWARE = [
    ...
    "spatio-temporal.middleware.DataShareMiddleware",
]

ROOT_URLCONF = "spatio-temporal.urls"
...
WSGI_APPLICATION = "spatio-temporal.wsgi.application"
